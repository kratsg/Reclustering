...
ReclusteringStudies :: Helpers :: Helpers ()
{
}


struct ReclusteringStudies :: Helpers :: sort_by_pt
{
...
|                                                                               |
\*@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@*/
JetRecTool* ReclusteringStudies::Helpers::JetReclusteringStudiesTool(const std::string inputJetContainer, const std::string outputJetContainer, double radius, fastjet::JetAlgorithm rc_alg, float ptMin){
